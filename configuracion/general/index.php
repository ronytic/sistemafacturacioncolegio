...
$LlaveDosificacion2=$config->mostrarConfig("LlaveDosificacion2",1);
...
<div class="col-lg-12">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            <td class="text-right col-lg-3">Repite la Llave de Dosificación</td>
            <td><input type="text" name="LlaveDosificacion2" class="form-control" autofocus value="<?php echo $LlaveDosificacion2?>" required></td>
        </tr>
        <tr>
