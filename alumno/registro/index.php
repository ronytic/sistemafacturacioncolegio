...
if (!empty($_POST)) {
    ...
    if (in_array($a['CodCurso'], [1, 2, 4])) {
        $CodCurso = 3;
    }
    if (in_array($a['CodCurso'], [3])) {
        $CodCurso = 3;
    }
    if (in_array($a['CodCurso'], [5])) {
        $CodCurso = 1;
    }
            ...
            <div class="panel-body">
                <table>
                    ...
                    <tr>
                        ...
                        <td>::</td>
                        <td><input name="Paterno" type="text" size="30" required value="<?= $a['Paterno'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Apellido Materno</td>
                        <td>::</td>
                        <td><input name="Materno" type="text" size="30" required value="<?= $a['Materno'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Nombres</td>
                        <td>::</td>
                        <td><input name="Nombres" type="text" size="30" required value="<?= $a['Nombres'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Sexo</td>
                        <td>::</td>
                        <td><input type="radio" name="Sexo" id="h" value="1" required <?= $hombre ?? ''; ?> /><label for="h">Hombre</label>
                            <input type="radio" name="Sexo" id="m" value="0" required <?= $mujer ?? ''; ?>><label for="m">Mujer</label></td>
                    </tr>
                    <tr>
                        <td class="der">Lugar de Nacimiento</td>
                        <td>::</td>
                        <td><input type="text" name="LugarNac" placeholder="La Paz" value="<?= $a['LugarNac'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Fecha de Nacimiento</td>
                        <td>::</td>
                        <td><input type="date" name="FechaNac" id="FechaNac" size="10" value="<?= $a['FechaNac'] ?? ''; ?>" autocomplete="off" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Cedula de Identidad</td>
                        <td>::</td>
                        <td>
                            <?php carnet("Ci", "CiExt",  $a['Ci'] ?? '', $a['CiExt'] ?? ''); ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="der">Zona</td>
                        <td>::</td>
                        <td><input name="Zona" type="text" id="Zona" size="30" value="<?= $a['Zona'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Calle</td>
                        <td>::</td>
                        <td><input name="Calle" type="text" id="Zona" size="30" value="<?= $a['Calle'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Número</td>
                        <td>::</td>
                        <td><input name="Numero" type="text" id="Zona" size="30" value="<?= $a['Numero'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Teléfono Casa</td>
                        <td>::</td>
                        <td><input name="TelefonoCasa" type="text" id="FechaNac" size="30" value="<?= $a['TelefonoCasa'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Celular</td>
                        <td>::</td>
                        <td><input name="Celular" type="text" size="30" value="<?= $a['Celular'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                </table>
                <hr>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                <input name="MontoPagar" id="MontoPagar" readonly class="form-control" type="text" value="<?php echo $c['MontoCuota'] ?? '' ?>" /> <span class="input-group-addon">Bs</span></div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>::</td>
                        <td><input type="text" name="Rude" value="<?= $a['Rude'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <!--<tr><td class="der">Foto</td><td>::</td><td><input type="file" name="Foto" disabled="disabled"/></td></tr>-->
                    <tr>
                        <td class="der">Observaciones</td>
                        <td>::</td>
                        <td><textarea name="Observaciones" cols="30" rows="5" class="form-control"><?= $a['Observaciones'] ?? ''; ?></textarea></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="panel-body">
                <table>
                    <tr>
                        ...
                        <td>::</td>
                        <td><input type="text" name="ApellidosPadre" size="50" value="<?= $a['ApellidosPadre'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Nombre del Padre</td>
                        <td>::</td>
                        <td><input type="text" name="NombrePadre" size="50" value="<?= $a['NombrePadre'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">C.I. Padre</td>
                        <td>::</td>
                        <td><?php carnet("CiPadre", "CiExtP", $a["CiPadre"] ?? '', $a["CiExtP"] ?? ''); ?></td>
                    </tr>
                    <tr>
                        <td class="der">Ocupación del Padre</td>
                        <td>::</td>
                        <td><input type="text" name="OcupPadre" size="30" value="<?= $a['OcupPadre'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Celular Padre</td>
                        <td>::</td>
                        <td><input type="text" name="CelularP" size="30" value="<?= $a['CelularP'] ?? ''; ?>" class="form-control" /></td>
                    </tr>

                    <tr>
                        <td class="der">Apellidos de la Madre</td>
                        <td>::</td>
                        <td><input type="text" name="ApellidosMadre" size="50" value="<?= $a['ApellidosMadre'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Nombre de la Madre</td>
                        <td>::</td>
                        <td><input type="text" name="NombreMadre" size="50" value="<?= $a['NombreMadre'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">C.I.Madre</td>
                        <td>::</td>
                        <td><?php carnet("CiMadre", "CiExtM", $a["CiMadre"] ?? '', $a["CiExtM"] ?? ''); ?></td>
                    </tr>

                    <tr>
                        <td class="der">Ocupación de la Madre</td>
                        <td>::</td>
                        <td><input type="text" name="OcupMadre" size="30" value="<?= $a['OcupMadre'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Celular Madre</td>
                        <td>::</td>
                        <td><input name="CelularM" type="text" id="CelularM" size="30" value="<?= $a['CelularM'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Email</td>
                        <td>::</td>
                        <td><input type="text" name="Email" size="30" value="<?= $a['Email'] ?? ''; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td class="der">Persona Encargada para Recoger</td>
                        <td>::</td>
                        <td><input type="text" name="PersonaACargo" size="30" value="<?= $a['PersonaACargo'] ?? ''; ?>" class="form-control" //> </td> </tr> </table> <hr>
                            <table>
                                <tr>
                                    <td class="der">NIT</td>
                                    <td>::</td>
                                    <td><input name="Nit" type="text" id="Nit" size="30" required value="<?= $a['Nit'] ?? ''; ?>" class="form-control" /></td>
                                </tr>
                                <tr>
                                    <td class="der">Nombre a Facturar</td>
                                    <td>::</td>
                                    <td><input name="FacturaA" type="text" size="30" required value="<?= $a['FacturaA'] ?? ''; ?>" class="form-control" //> </td> </tr> </table> <hr />
                                        <table class="table table-hover table-bordered">
                                            <tr>
                                                <td class="der"><label for="cn" class="form-label">Certificado de Nacimiento</label></td>
                                                <td>::</td>
                                                <td><input type="checkbox" name="CertificadoNac" id="cn" <?= $CertificadoNac ?? ''; ?> /></td>
                                            </tr>
                                            <tr>
                                                <td class="der"><label for="le" class="form-label">Libreta Escolar</label></td>
                                                <td>::</td>
                                                <td><input type="checkbox" name="LibretaEsc" id="le" <?= $LibretaEsc ?? ''; ?> /></td>
                                            </tr>
                                            <tr>
                                                <td class="der"><label for="lv">Libreta de Vacunas</label></td>
                                                <td>::</td>
                                                <td><input type="checkbox" name="LibretaVac" id="lv" <?= $LibretaVac ?? ''; ?> /></td>
                                            </tr>
                                            <tr>
                                                <td class="der"><label for="CedulaId">C.I. del Alumno</label></td>
                                                <td>::</td>
                                                <td><input type="checkbox" name="CedulaId" id="CedulaId" <?= $CedulaId ?? ''; ?> /></td>
                                            </tr>
                                            <tr>
                                                <td class="der"><label for="CedulaIdP">C.I. del Padre</label></td>
                                                <td>::</td>
                                                <td><input type="checkbox" name="CedulaIdP" id="CedulaIdP" <?= $CedulaIdP ?? ''; ?> /></td>
                                            </tr>
                                            <tr>
                                                <td class="der"><label for="CedulaIdM">C.I. de la Madre</label></td>
                                                <td>::</td>
                                                <td><input type="checkbox" name="CedulaIdM" id="CedulaIdM" <?= $CedulaIdM ?? ''; ?> /></td>
                                            </tr>
                                            <tr>
                                                <td class="der"><label for="Croquis">Croquis de Domicilio</label></td>
                                                <td>::</td>
                                                <td><input type="checkbox" name="Croquis" id="Croquis" <?= $Croquis ?? ''; ?> /></td>
                                            </tr>
                                            <tr>
                                                <td class="der"><label for="Fotografia">Fotografías</label></td>
                                                <td>::</td>
                                                <td><input type="checkbox" name="Fotografia" id="Fotografia" <?= $Fotografia ?? ''; ?> /></td>
                                            </tr>
                                            <tr>
                                                <td class="der">Observaciones Documentos</td>
                                                <td>::</td>
                                                <td><textarea name="ObservacionesDoc" rows="5" cols="30" class="form-control"><?= $Observaciones ?? ''; ?></textarea></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td></td>
