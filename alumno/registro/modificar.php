...
<form action="../actualizaralumno.php" method="post" onSubmit="if(this.Curso.value==0){alert('Selecciona el Curso');return false;}">
<div class="col-lg-6">
	<div class="panel panel-default">
		<div class="panel-heading">Datos del Alumno</div>
        <div class="panel-body">
					<table>
            	<tr><td class="der">Matricula</td><td>::</td><td><input name="Matricula" type="text" id="matricula" value="<?php echo $al['CodAlumno']?>" size="30" readonly class="form-control"/></td></tr>
                ...
                <tr><td class="der">Nombres</td><td>::</td><td><input name="Nombres" type="text" size="30" required  value="<?php echo $al['Nombres'];?>" class="form-control"/></td></tr>
        	...
        	<table>
                ...
                <tr><td class="der">Retirado</td><td>::</td><td><input type="radio" name="Retirado" value="0" id="n" checked="checked"/><label for="n">No</label><input type="radio" name="Retirado" value="1" id="s"/><label for="s">Si</label></td></tr>
                 ...
                 <tr><td class="der">Rude</td><td>::</td><td><input type="text" name="Rude" value="<?php echo $al['Rude'];?>" class="form-control"/></td></tr>
...
<hr>
            ...
            <table class="table table-hover table-bordered">
            	<tr><td class="der"><label for="cn" class="form-label">Certificado de Nacimiento</label></td><td>::</td><td><input type="checkbox" name="CertificadoNac" id="cn" <?php echo $doc['CertificadoNac']?'checked="checked"':'';?>/></td></tr>
                <tr><td class="der"><label for="le" class="form-label">Libreta Escolar</label></td><td>::</td><td><input type="checkbox" name="LibretaEsc" id="le" <?php echo $doc['LibretaEsc']?'checked="checked"':'';?>/></td></tr>
                ...
                <tr><td class="der"><label for="Croquis">Croquis de Domicilio</label></td><td>::</td><td><input type="checkbox" name="Croquis" id="Croquis" <?php echo $doc['Croquis']?'checked="checked"':'';?>/></td></tr>
                  <tr><td class="der"><label for="Fotografia">Fotografías</label></td><td>::</td><td><input type="checkbox" name="Fotografia" id="Fotografia" <?php echo $doc['Fotografia']?'checked="checked"':'';?>/></td></tr>
