...
include_once("fpdf_protection.php");
	...
	class PPDF extends FPDF_Protection{
		...
		function Header(){
			...
			$this->SetTitle(utf8_decode("Sistema de Administración de Inventario, Ventas y Facturación"),true);
			$this->SetAuthor(utf8_decode("Sistema de Administración de Inventario, Ventas y Facturación Desarrollado por Ronald Nina Layme. Cel: 73230568 - www.facebook.com/ronaldnina"),true);
			$this->SetSubject(utf8_decode("Sistema de Administración de Inventario, Ventas y FacturaciónDesarrollado por Ronald Nina Layme. Cel: 73230568 - www.facebook.com/ronaldnina"),true);
			$this->SetCreator(utf8_decode("Sistema de Administración de Inventario, Ventas y Facturación Desarrollado por Ronald Nina Layme. Cel: 73230568 - www.facebook.com/ronaldnina"),true);
		...
		{	global $lema,$idioma,$DatosGenerador;
			...
			if($this->CurOrientation=="P" ||$this->OrientacionObligada=="L"){
				$this->Cell((round(($this->ancho-50)/2)+0),3,utf8_decode("Sistema de Administración de Inventario, Ventas y Facturación"),$BordePie,0,"R");
				$this->ln();
				...
				$this->Cell((round(($this->ancho-50)/2)-5),3,utf8_decode("Sistema de Administración de Inventario, Ventas y Facturación - Desarrollado por Ronald Nina"),$BordePie,0,"R");	
			}
