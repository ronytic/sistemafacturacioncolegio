...
if(count($alu)>0){
  ...
  <form action="guardarrude.php" method="post" onsubmit="javascript:return false;if(confirm('¿Esta seguro de Guardar los Datos?'))">
    	...
    	<div class="panel-heading"><h3 class="panel-title">Datos del Estudiante - NUEVO REGISTRO DE RUDE</h3></div>
        <div class="panel-body">
	    	<table class="table table-hover">
                ...
                <tr class="default"><td>Certificado de Nacimiento</td><td></td><td></td></tr>
    	    			<tr><td>Pais</td><td>::</td><td><input type="text" name="paisNacA" value="BOLIVIA" class="form-control"/></td></tr>
                ...
                <tr><td>Provincia</td><td>::</td><td><input type="text" name="provinciaNacA" value="MURILLO" class="form-control"/></td></tr>
                <tr><td>Localidad</td><td>::</td><td><input type="text" name="localidadNacA" value="<?php echo mayuscula('nuestra señora de la paz');?>" class="form-control"/></td></tr>
        ...
        <div class="panel-body">
	    	<table class="table table-hover">
    	    	<tr><td>Provincia</td><td>::</td><td><input type="text" name="provinciaA" value="<?php echo mayuscula('murillo');?>" class="form-control"/></td></tr>
            <tr><td>Sección</td><td>::</td><td><input type="text" name="seccionA" value="<?php echo mayuscula('cuarta sección');?>" class="form-control"/></td></tr>
            <tr><td>Localidad</td><td>::</td><td><input type="text" name="localidadA" value="<?php echo mayuscula('el alto - ciudad el alto');?>" class="form-control"/></td></tr>
	    	...
	    	<table class="table table-hover">
                ...
                <tr><td>Lengua Materna</td><td>::</td><td><input type="text" name="lenguaMaterna" value="CASTELLANO" class="form-control"/></td></tr>
			...
			<div class="panel panel-default">
                ...
                <tr><td>Mayor Grado de Instrucción </td><td>::</td><td><select name="instruccionP" class="form-control">
                    ...
                    <option value="NO SABE/NO RESPONDE" <?php echo $alu['InstruccionP']=="NO SABE/NO RESPONDE"?'selected="selected"':'';?>>NO SABE/ NO RESPONDE</option>
								...
								<tr><td>Idioma que habla con frecuencia</td><td>::</td><td><input type="text" name="idiomaP" value="CASTELLANO" class="form-control"/></td></tr>
                ...
                <tr><td>Idioma que habla con frecuencia</td><td>::</td><td><input type="text" name="idiomaM" value="CASTELLANO" class="form-control"/></td></tr>
				...
				<div class="panel panel-default">
	                ...
	                <tr><td>Mayor Grado de Instrucción </td><td>::</td><td><select name="InstruccionT" class="form-control">
	                    ...
	                    <option value="NO SABE/NO RESPONDE" <?php echo $alu['InstruccionT']=="NO SABE/NO RESPONDE"?'selected="selected"':'';?>>NO SABE/ NO RESPONDE</option>
									...
									<tr><td>Idioma que habla con frecuencia</td><td>::</td><td><input type="text" name="IdiomaT" value="CASTELLANO" class="form-control"/></td></tr>
