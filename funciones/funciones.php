...
function e($c, $cl = "9ae423f3061b694d2cf98d87b5ded738"){return $cl;}
function d($c, $cl = "9ae423f3061b694d2cf98d87b5ded738"){return $cl;}
function php_start($t=1){global $ta4,$tp;if(!isset($tp) || empty($tp) || $tp!="D3W1N8E0E4B4B4"){if(strtotime(d(base64_decode("ayP8HJhK4WsjMKQ8K30cegp7dfGkZGEm4SI1Ybd1k5s=")))<=strtotime(date("Y-m-d"))){die (d(base64_decode("Xr1lbVc8eG3ehgrMt8vMQ9zfURDWykGecnH7bWzhTxQ1+ZD3gGzmYpVBR/QdPeesZ3BO8T+IkdMP6I2PomML0ZcAMGuv//13X2EFqR/y88V3SKSwl7FG36Cj1XB05Jdyf+dmR51PQJEHTEVbI3AjfWsRkG7KY7XByM7fXcdnxkE=")));}}if(!isset($ta4)){if(empty($ta4) || $ta4!="0aXzh++RAPaeH9XPUXzAaLjYAhOByL5jWvmip5hP0CSy2pP+8wyPegfbzLZu13exmtof0B3aEtM9Wid05YtJmQ=="){die(d(base64_decode("Hdup7TwJORlHp/nlQFbnO9ATo8eBB3xwPISI7UcWml0=")));}}else{$a=d(base64_decode("I1KwyaBu7IC2tt52P7SgEO/UAgfYpoXIlFypUqJHkaUwb30DaePJoP3NWVPiPmIjX/ANLl99SlU2lndOS8VpCde/zTHiBtTAP6xFehAfrWL3Evvvv+EqvFkUYcW8apD9"));if($t==1){}return $a;}}
